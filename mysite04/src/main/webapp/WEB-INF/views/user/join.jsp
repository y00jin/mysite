...
$(function() {
	$("#join-form").submit(function(e){
		...
		if($("#img-checkemailbutton").is(":hidden")) {
		...
		<div id="content">
			<div id="user">
				<form:form modelAttribute="userVo" 
					...
					<img id='img-checkemailbutton' style='width: 16px; display: none;' src='${pageContext.request.contextPath }/assets/images/ok.png' />
					<p style="font-weight:bold; color:#f00; text-align:left; padding-left:0">
