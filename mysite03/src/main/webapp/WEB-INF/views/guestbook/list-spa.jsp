...
$(function() {
	...
	$("#add-form").submit(function(event) {
		...
		if(vo.name == '') {
			messageBox('방명록 남기기', '이름은 필수 항목입니다.', function() {
				$("#input-name").focus();
			});
			return;
		}
		...
		if(vo.password == '') {
			messageBox('방명록 남기기', '비밀번호는 필수 항목입니다.', function() {
		...
		if(vo.contents == '') {
			messageBox('방명록 남기기', '내용은 필수 항목입니다.', function() {
				$("#tx-content").focus();
			});
			return;
		}
...
<body>
	<div id="container">
		...
		<div id="content">
			...
			<div class="delete-form" id="dialog-delete-form" title="메세지 삭제" style="display:none">
